    ...
    <div>
      <section className='map mb-5'>
        <div className='contact-banner  position-relative  '>
          <img alt='Banner' style={{maxHeight:"150px", minHeight:"60px"}} src={data?.banner?.length ? data?.banner[0]?.img?.data?.attributes?.url : banner} width={1000} height={200} className='w-100 z-1 policyImgHieght  object-fit-cover' />
